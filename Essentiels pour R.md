...
- [**R Universe**](https://r-universe.dev/search) : collection de packages R.
...
- [**What they forgot to teach you about R**](https://rstats.wtf/) : un titre pompeux ou ironique mais beaucoup de très bons conseils sur la gestion d'un projet R.
...
- [**{procs}**](https://procs.r-sassy.org/articles/procs.html) reproduit de nombreuses procédures SAS (*`freq`, `means`, `report`, etc.). Il fait partie de l'écosystème https://sassy.r-sassy.org/, conçu pour faciliter la transition SAS → R.

## Le tidyverse

Le [**{tidyverse}**](https://tidyverse.org/) inclut notamment :
...
### Packages de modèles d'économétries utiles
